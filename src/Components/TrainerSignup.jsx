...
export default function TrainerSignup({ onClose, switchToTLogin }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (validateForm()) {
      setLoading(true);
      try {
        const response = await axios.post('http://localhost:8080/api/trainer/signup', {
          name: name,
          email: email,
          password: password,
          role:role
      ...
      <div className="modal-content">
        ...
        <div className="signup">
          <form onSubmit={handleSubmit}>
            ...
            <p className="login-link" onClick={() => navigate('/tl')}>
